...
<div class="container">
	...
	jq(document).ready(function() {
		table = jq('#table').DataTable({ 
			...
			"ajax": {
				"url": "<?php echo site_url('admin/company_list/')?>",
				"type": "POST"
			},
	...
	function edit_entry(key)
	{
		...
		jq.ajax({
			url : "<?php echo site_url('admin/company_edit')?>/",
			type: "POST",
			data: { reg_no: key },
			dataType: "JSON",
	...
	function save()
	{
		...
		if(save_method == 'add') 
		{
			url = "<?php echo site_url('admin/company_add/')?>";
			_form = "#form_add";
		}
		else
		{
			url = "<?php echo site_url('admin/company_update/')?>";
			_form = "#form_update";
		}
	...
	function delete_entry(key)
	{
		if(confirm('Are you sure delete this data?'))
		{
			...
			jq.ajax({
				url : "<?php echo site_url('admin/company_delete')?>/",
				type: "POST",
				data: { reg_no: key },
				dataType: "JSON",
				success: function(data)
				...
				<div class="modal-body form">
					<form action="#" id="form_add" class="form-horizontal">
						...
						<div class="form-body">
							...
							<div class="form-group">
								<label class="control-label col-md-3">Company Admin</label>
								<div class="col-md-9">
									<input required type="text" class="form-control" id="inputAdmin" name="inputAdmin" placeholder="Company Admin">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">Company Name</label>
								<div class="col-md-9">
									<input required type="text" class="form-control" id="inputName" name="inputName" placeholder="Company Name">
								</div>
							</div>
							<div class="form-group">
